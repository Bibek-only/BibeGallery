...
export default function HomePage() {
  ...
  return isLoading ? (
    <Loader isLoading={true} message="Loading the images" />
  ) : (
    <div className="container mx-auto px-4 py-8">
      {!Array.isArray(publicImages) || publicImages.length === 0 ? (
        <div className="flex items-center justify-center md:h-100">
          <p className="mb-8 text-3xl font-bold">There Are No Images Yet</p>
        </div>
      ) : (
